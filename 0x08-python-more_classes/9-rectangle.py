...
class Rectangle:
    ...
    """Magic function to delete instance of the Rectangle class"""
    def __del__(self):
        """delete instance of Rectangle class, and prints a message"""
        print("Bye rectangle...")
        Rectangle.number_of_instances -= 1
    ...
    def __str__(self):
        ...
        for itr in range(self.__height):
            [rect_obj.append(str(self.print_symbol))
    ...
    def bigger_or_equal(rect_1, rect_2):
        """Static method checks which rectangle is bigger
        Args:
            rect_1: first Rectangle (Rectangle).
            rect_2: second Rectangle (Rectangle).
        Raises:
            TypeError: if both objects are not instances of Rectangle.
        Returns:
            the bigger rectangle based on their areas
        """
    ...
    def square(cls, size=0):
        """Method that creates new Rectangle with width and height equal size
        Args:
            cls: class_object (class)
            size: Width and height of the new Rectangle (int).
        """
